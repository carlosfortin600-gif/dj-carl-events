...
function isOtherCocktailLocation(location) {
  return location === "other_room" || location === "outside";
}

function normalizeCocktailLocationFields(location, equipmentProvided, place, distance) {
  if (!isOtherCocktailLocation(location)) {
    return { place: "", distance: "" };
  }
  if (equipmentProvided !== "yes") {
    return { place: place || "", distance: "" };
  }
