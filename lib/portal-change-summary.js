  ...
  return [
    {
      ...
      fields: [
        ...
        { key: "general_notes", label: "Note générale" },
        { key: "wedding_has_color", label: "Couleur spécifique pour le mariage" },
        { key: "wedding_color", label: "Couleur(s) du mariage" }
      ]
    },
    {
    ...
    {
      section: "Responsable de la salle",
      before: (q) => q.venue_contact,
      after: (q) => q.venue_contact,
      fields: [
        { key: "name", label: "Nom" },
        { key: "technical_fog_allowed", label: "Brouillard technique autorisé" },
        { key: "phone", label: "Téléphone" },
        { key: "email", label: "Courriel" }
      ]
    },
    {
      ...
      after: (q) => q.ceremony,
      fields: [
        { key: "ceremony_room", label: "Lieu" },
        { key: "ceremony_place", label: "Endroit" },
        { key: "equipment_provided", label: "Équipement selon l'entente" },
        { key: "sound_provided", label: "Sono selon l'entente" },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "equipment_provided", label: "Deuxième kit de son" },
    ...
    },
    {
      ...
      after: (q) => q.dinner,
      fields: [
        { key: "service_type", label: "Type de souper" },
        { key: "styles", label: "Styles de musique" },
        { key: "requests", label: "Commentaires" }
      ]
    },
  ...
  return [
    {
      ...
      fields: [
        ...
        { key: "thematic_evening", label: "Soirée thématique" },
        { key: "evening_themes", label: "Thème" },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "cocktail_equipment_provided", label: "Deuxième kit de son" },
        { key: "has_meal", label: "Repas" },
        { key: "meal_service_type", label: "Type de souper" },
        { key: "meal_bouchee", label: "Bouchée" },
    ...
    },
    {
      ...
      after: (q) => q.cocktail,
      fields: [
        { key: "styles", label: "Styles désirés" },
        { key: "requests", label: "Demandes spéciales" }
      ]
    },
    {
      ...
      after: (q) => q.dinner,
      fields: [
        { key: "styles", label: "Style(s) de musique" },
        { key: "requests", label: "Commentaires" }
      ]
    },
    {
...
function summarizePortalChanges({ before, after, eventType, kind }) {
  ...
  if (kind === "musique") {
    compareObjectFields(changes, "Musique", before.party_music, after.party_music, [
      { key: "decades", label: "Décennies" },
      { key: "must_play", label: "À jouer absolument" },
      { key: "preferred_artists", label: "Artistes préférés" },
      { key: "forbidden_songs", label: "Chansons interdites" },
  ...
  if (kind === "plan-soiree") {
    ...
    compareField(
      ...
      "Plan de soirée",
      "Heure fin de danse",
      before.general?.expected_end_time,
      after.general?.expected_end_time
    );
  } else {
...
function summarizeFullDossierChanges(before, after, eventType) {
  const questionnaireChanges = summarizePortalChanges({
    before,
    after,
    eventType,
    kind: "questionnaire"
  });
  const planChanges = summarizePortalChanges({
    before,
    after,
    eventType,
    kind: "plan-soiree"
  ...
  const seen = new Set();
  const merged = [];
  for (const change of [...questionnaireChanges, ...planChanges]) {
    const key = `${change.section}|${change.label}|${change.before}|${change.after}`;
