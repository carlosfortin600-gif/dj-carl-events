...
function bodyToQuestionnaire(body) {
  ...
  data.cocktail_dinner.styles = parseCheckboxList(body, "cocktail_styles");
  Object.assign(data.cocktail_dinner, {
    cocktail_location: body.cocktail_location || "",
    cocktail_place: body.cocktail_place || "",
    cocktail_dj_distance: body.cocktail_dj_distance || "",
    dinner_requests: body.dinner_requests || ""
  });
...
function mergeQuestionnaire(stored) {
  ...
  merged.cocktail_dinner = { ...base.cocktail_dinner, ...(stored.cocktail_dinner || {}) };
