...
function bodyToQuestionnaire(body) {
  ...
  Object.assign(data.general, {
    ...
    wedding_has_color: yn(body.wedding_has_color),
    wedding_color: body.wedding_color?.trim() || ""
  });

  Object.assign(data.ceremony, {
    ceremony_room: body.ceremony_room || "",
    ceremony_place: body.ceremony_place?.trim() || body.ceremony_location?.trim() || "",
    location: body.ceremony_place?.trim() || body.ceremony_location?.trim() || "",
    start_time: body.ceremony_start_time || "",
    end_time: body.ceremony_end_time || "",
    equipment_provided: yn(body.ceremony_equipment_provided),
    sound_provided: yn(body.ceremony_sound_provided)
  });
  ...
  Object.assign(data.cocktail, {
    ...
    equipment_provided: yn(body.cocktail_equipment_provided),
    requests: body.cocktail_requests?.trim() || ""
  });

  if (!isOtherCocktailLocation(data.cocktail.cocktail_location)) {
    data.cocktail.equipment_provided = "";
  }
  const cocktailFields = normalizeCocktailLocationFields(
    data.cocktail.cocktail_location,
    data.cocktail.equipment_provided,
    data.cocktail.cocktail_place,
    data.cocktail.cocktail_dj_distance
  );
  data.cocktail.cocktail_place = cocktailFields.place;
  data.cocktail.cocktail_dj_distance = cocktailFields.distance;
  ...
  Object.assign(data.dinner, {
    ...
    service_type: body.dinner_service_type || "",
...
function mergeQuestionnaire(stored) {
  ...
  if (typeof merged.general.expected_end_time !== "string") {
    merged.general.expected_end_time = "";
  }
  if (typeof merged.general.wedding_has_color !== "string") {
    merged.general.wedding_has_color = merged.general.wedding_color ? "yes" : "";
  }
  if (typeof merged.general.wedding_color !== "string") {
    merged.general.wedding_color = "";
  }
  merged.ceremony = { ...base.ceremony, ...(stored.ceremony || {}) };
  if (!merged.ceremony.ceremony_place && merged.ceremony.location) {
    merged.ceremony.ceremony_place = merged.ceremony.location;
  }
