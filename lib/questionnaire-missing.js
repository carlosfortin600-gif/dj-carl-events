...
function getWeddingMissingFields(q) {
  ...
  checkRadio(items, q, wedding, "Cocktail", "Équipement selon l'entente", "cocktail_equipment_provided", cd.equipment_provided);
...
function getPartyMissingFields(q) {
  ...
  checkRadio(items, q, wedding, "Déroulement", "Équipement selon l'entente", "cocktail_equipment_provided", sch.cocktail_equipment_provided);
