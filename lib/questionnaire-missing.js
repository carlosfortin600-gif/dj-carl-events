...
function getWeddingMissingFields(q) {
  ...
  checkRadio(items, q, wedding, "Cocktail et repas", "Cocktail — emplacement", "cocktail_location", cd.cocktail_location);
  checkText(items, q, wedding, "Cocktail et repas", "Lieu / endroit", "cocktail_place", cd.cocktail_place);
  checkText(items, q, wedding, "Cocktail et repas", "Distance du DJ au cocktail", "cocktail_dj_distance", cd.cocktail_dj_distance);
  checkCheckboxGroup(items, q, wedding, "Cocktail et repas", "Styles désirés (cocktail)", "cocktail_styles", cd.styles);
  checkText(items, q, wedding, "Cocktail et repas", "Demandes spéciales pour le souper", "dinner_requests", cd.dinner_requests);
