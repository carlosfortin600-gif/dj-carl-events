...
function buildDjNotesSection(djNotes) {
  ...
  return section("Notes DJ (privées)", [
    ...
    row(
      "E-mail pour prendre RDV envoyé",
      djNotes?.tech_email_rdv_sent === "yes"
        ? formatDateTimeFr(djNotes?.tech_email_rdv_date, djNotes?.tech_email_rdv_time) || "Oui"
        : djNotes?.tech_email_rdv_sent === "no"
          ? "Non"
          : "—"
    ),
