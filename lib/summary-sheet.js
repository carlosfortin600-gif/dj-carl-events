...
function buildWeddingQuestionnaireSections(q) {
  ...
  return [
    ...
    section("Repas", [
      row("Emplacement", cocktailLocationLabel(dinner.dinner_location)),
      row("Lieu / endroit", dinner.dinner_place),
      row("Distance DJ", dinner.dinner_dj_distance),
      row("Styles désirés", listLabel(dinner.styles)),
      row("Demandes spéciales", dinner.requests)
    ]),
