const { formatDateFr, formatTime, formatDateTimeFr, formatTimestampFr, formatDateRangeFr, formatDateTimeRangeFr, localTimestampNow, endDatetimeLocalValue, statusLabel, clientFullName, googleMapsUrl, googleMapsDirectionsUrl, compareChronologicalTime } = require("./helpers");
